...
namespace SistemaVendas.Controllers
{
    public class RelatorioController : Controller
    {
        ...
        public IActionResult Vendas(RelatorioModel relatorio)
        {
            ...
            {
                string DateDe = relatorio.DataDe.ToString("yyyy/MM/dd");
                string DateAte = relatorio.DataAte.ToString("yyyy/MM/dd");
                ViewBag.ListaVendas = new VendaModel().ListagemVendas(DateDe, DateAte);
            }
        ...
        public IActionResult Grafico()
        {
            ...
            // Percorre a lista para compor os itens do gráfico
            for (int i = 0; i < lista.Count; i++)
            {
                valores += lista[i].QtdeVendido.ToString() + ",";
                labels += "'" + lista[i].DescricaoProduto.ToString() + "',";
                
                // escolher aleatoriamente para compor as partes do gráfico tipo torta
